...
- [sirupsen/logrus](https://github.com/sirupsen/logrus) ([v1.8.0](https://github.com/sirupsen/logrus/releases/tag/v1.8.0), 5 days ago) - Structured, pluggable logging for Go.

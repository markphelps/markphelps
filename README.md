...
- [markcheno/go-talib](https://github.com/markcheno/go-talib) - A pure Go port of TA-Lib (http://ta-lib.org) (6 days ago)
...
- [mehanizm/airtable](https://github.com/mehanizm/airtable) - Simple golang airtable API wrapper (4 weeks ago)

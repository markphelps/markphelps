...
- [markphelps/flipt](https://github.com/markphelps/flipt) ([v1.2.1](https://github.com/markphelps/flipt/releases/tag/v1.2.1), 1 day ago) - An open-source, on-prem feature flag solution
- [sirupsen/logrus](https://github.com/sirupsen/logrus) ([v1.8.1](https://github.com/sirupsen/logrus/releases/tag/v1.8.1), 1 day ago) - Structured, pluggable logging for Go.
